<script lang="ts">
    ...
    async function submitCode() {
        ...
        try {
            const response = await fetch('https://rakathon-proxy.manakjiri.cz/patient', {
                method: 'POST',
                headers: {
            ...
            status = 'error';
            error = err instanceof Error ? err.message : 'Failed to connect to doctor. Please check the code and try again.';
        }
    }
...
<div class="container">
    ...
    <div class="input-container">
        <label for="code-input">Enter the 6-digit code provided by your doctor:</label>
        <input 
            id="code-input"
            type="text"
            bind:value={code}
